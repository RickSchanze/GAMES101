...
namespace rst
{
    ...
    public:
        ...
        void SetPixelNoBlackEdge(const Eigen::Vector3f& point, const Eigen::Vector3f& color, int index);
    ...
    private:
        ...
        std::vector<Matrix<Vector3f, 1, 4>> frame_color_buf;
